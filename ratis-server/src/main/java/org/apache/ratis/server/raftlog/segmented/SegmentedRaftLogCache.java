...
public class SegmentedRaftLogCache {
  ...
  boolean shouldEvict() {
    ...
    LOG.info("YYYY: should: " + (closedSegmentsCacheInfo.getCount() > maxCachedSegments) + ", closedSegmentsCacheInfo.getCount(): " + closedSegmentsCacheInfo.getCount() + ", maxCachedSegments: " + maxCachedSegments);
    ...
    LOG.info("YYYY: should: " + (size > maxSegmentCacheSize) + " size: " + size + ", maxSegmentCacheSize: " + maxSegmentCacheSize);
